...
public class TaskController {
    ...
    public void removeById(int taskId){
        ...
        try{
            ...
            connection = ConnectionFactory.getConnection();
            // Preparando a query.
            statement = connection.prepareStatement(sql); //ajuda a preparar o comando para ser executado a conexão.
            // Setando os valores.
    ...
    public List<Task> getAll(int idProject){
        ...
        Connection connection = null;
        PreparedStatement statement = null;
        ResultSet resultSet = null; // guarda as respostas do banco de dados.
        ...
        try {
            ...
            // Equanto houverem valores a serem percorridos no meu resultSet.
